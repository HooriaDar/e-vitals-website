    ...
    <div className="w-full">
      <section className="mx-auto max-w-7xl px-6 pt-12 pb-16 animate-rise">
        <nav className="mb-6 text-sm text-slate-500">
          ...
          <span className="text-plum">Cardiology</span>
        </nav>
        
        <div className="max-w-3xl">
          <p className="inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.08em] text-brand">
            <span className="h-px w-6 bg-brand"></span>Who we serve · Cardiology
          </p>
          <h1 className="mt-4 text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl text-plum">
            Remote care for cardiology practices.
          </h1>
          <p className="mt-5 text-lg text-slate-600">
            In cardiology, daily physiologic data is often the difference between catching decompensation early and an avoidable admission. eVitals streams the readings your team needs to act sooner.
          </p>
            ...
            <div className="rounded-2xl bg-white p-7 ring-1 ring-slate-200 shadow-sm">
              ...
              <ul className="mt-4 space-y-3">
                <li className="flex gap-3 text-slate-600">
                  ...
                  <span>Daily blood pressure, heart rate, and weight tracking to flag heart-failure decompensation early</span>
                </li>
                <li className="flex gap-3 text-slate-600">
                  <svg className="h-5 w-5 flex-none text-emerald-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                    <path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span>Fewer emergency visits and hospital readmissions</span>
                </li>
                <li className="flex gap-3 text-slate-600">
                  <svg className="h-5 w-5 flex-none text-emerald-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                    <path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span>Confidence that their care team is watching between visits</span>
                </li>
                <li className="flex gap-3 text-slate-600">
                  <svg className="h-5 w-5 flex-none text-emerald-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                    <path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span>Medication titration informed by real, day-to-day data</span>
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-2xl bg-white p-7 ring-1 ring-slate-200 shadow-sm">
              ...
              <ul className="mt-4 space-y-3">
                <li className="flex gap-3 text-slate-600">
                  ...
                  <span>Reduce 30-day readmissions that affect quality scores and penalties</span>
                </li>
                <li className="flex gap-3 text-slate-600">
                  <svg className="h-5 w-5 flex-none text-emerald-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                    <path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span>Reimbursable RPM for CHF, hypertension, and post-event monitoring</span>
                </li>
                <li className="flex gap-3 text-slate-600">
                  <svg className="h-5 w-5 flex-none text-emerald-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                    <path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span>Trend dashboards that surface at-risk patients first</span>
                </li>
                <li className="flex gap-3 text-slate-600">
                  <svg className="h-5 w-5 flex-none text-emerald-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                    <path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span>Audit-ready documentation for value-based contracts</span>
                </li>
              </ul>
            </div>
          </div>
          <p className="mt-8 text-sm text-slate-500">
            <span className="font-semibold text-plum">Conditions we commonly support:</span> Congestive heart failure, hypertension, post-MI, and arrhythmia management.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 animate-rise">
        <div className="rounded-3xl bg-brand-tint px-8 py-14 text-center ring-1 ring-brand/15 sm:px-12">
          <h2 className="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-plum sm:text-4xl">
            Bring eVitals to your cardiology practice.
          </h2>
